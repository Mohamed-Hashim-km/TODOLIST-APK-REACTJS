...
function ToDo() {
  ...
  const [todoList, setTodoList] = useState(localData ? JSON.parse(localData) : []);
  ...
  //   } else if (todomapStatus === true) {
  //     setfilterTodos(completeTodoList);
  //   } else if (todomapStatus === false) {
  //     setfilterTodos(uncompleteTodoList);
  //   }
  // }, [todomapStatus, todoList, completeTodoList, uncompleteTodoList]);

  //========completebtn===================//

  // ======uncompletedbutton=============//
  // const unCompleteButtonHandler = () => {
  //   const unCopmleted = todoList.filter((value) => {
    ...
    <>
      <div className="flex justify-center mt-[5%] bg-stone-900 pb-10">
        <div className="border pt-4  px-12 min-h-[50%]  min-w-[40%] bg-white rounded-lg pb-[2%]">
          <ManageTodo taskTitleRef={taskTitleRef} taskDescriptionRef={taskDescriptionRef} mangeTodoHandler={mangeTodoHandler} isId={isId} setTodomapStatus={setTodomapStatus} />
